...
public class CO2FromWasteTester
{
   public static void main(String[] args)
   {
       ...
       cO2.add(new CO2FromWaste(1, false, true, true, true));
       cO2.add(new CO2FromWaste(5, false, false, true, true));
       cO2.add(new CO2FromWaste(2, false, false, false, true));
       cO2.add(new CO2FromWaste(7, false, false, false, false));
       cO2.add(new CO2FromWaste(3, true, false, false, false));
