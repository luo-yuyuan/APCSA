...
public class Pixel
{
 ...
 public double colorDistanceHSB(Color test)
 {
   float[] thisHSB = new float[3];
   Color.RGBtoHSB(this.getRed(), this.getGreen(), this.getBlue(), thisHSB);
     
   float[] testHSB = new float[3];
   Color.RGBtoHSB(test.getRed(), test.getGreen(), test.getBlue(), testHSB);
   
   double hueDistance = thisHSB[0] - testHSB[0];
   double saturationDistance = thisHSB[1] - testHSB[1];
   double brightnessDistance = thisHSB[2] - testHSB[2];
